...
@section('body')
    <div class="header-section">
        <div class="first-child">
            ...
            <div class="text">
                <span class="title"> <span style="color: aqua;">Welcome to REEF RESOURCES Financial Management</span>
                    At REEF RESOURCES Financial Management, we provide well-practiced and deft investing strategies with a
                    straightforward market approach to help our clients navigate through the market volatility and making
                    their welfare our prime concern.  </span>
    ...
    <div class="service">
        ...
        <div class="service-2">
            <p>
                ...
                financial crisis or meet your investment goals. With roots as an institutional fund,  Financial
                                    ...
                                    <div class="sin-testiText">
                                        ...
                                        <div class="people-say-content-list  ">
                                            ...
                                            <div>i have been with {{ $compd ? $compd->companyname : 'company name' }} for
                                                six years now and all i can say is that  has a great client
